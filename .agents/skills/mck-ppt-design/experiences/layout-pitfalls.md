...
## Experience 006: White line icons disappear on white slides

**Date**: 2026-07-24
**Problem**: Transparent PNG line icons were visually missing when placed directly on a white slide.
**Root Cause**: The bundled icon strokes are white and require a contrasting surface.
**Fix**: Place a navy or accent-color circle behind each white icon before adding the image.
**Rule**: During visual QA, verify transparent icon contrast; white line icons must always have a dark or colored backing shape.
